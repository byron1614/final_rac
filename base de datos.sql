...
CREATE TABLE alumnos(
  ...
  alum_nombre VARCHAR(100) NOT NULL,
  alum_apellido VARCHAR (100) NOT NULL,
  alum_grado VARCHAR(50) NOT NULL,
  alum_arma VARCHAR(50) NOT NULL,
  alum_nac VARCHAR(50) NOT NULL,
...
CREATE TABLE calificaciones(
  ...
  cali_alumno  INT NOT NULL,
  cali_materia INT NOT NULL,
  cali_punteo FLOAT NOT NULL,
  cali_resultado VARCHAR(10) NOT NULL,
  detalle_situacion CHAR(1) DEFAULT '1',
